...
val logbVersionName: String = providers.gradleProperty("versionName").getOrElse("0.14.0")
val logbVersionCode: Int = providers.gradleProperty("versionCode").map(String::toInt).getOrElse(1400)
