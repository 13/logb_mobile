...
val logbVersionName: String = providers.gradleProperty("versionName").getOrElse("0.9.0")
val logbVersionCode: Int = providers.gradleProperty("versionCode").map(String::toInt).getOrElse(900)
