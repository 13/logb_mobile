...
val logbVersionName: String = providers.gradleProperty("versionName").getOrElse("0.13.0")
val logbVersionCode: Int = providers.gradleProperty("versionCode").map(String::toInt).getOrElse(1300)
